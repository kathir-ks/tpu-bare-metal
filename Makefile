...
CPP_TESTS    = cpp_gradcheck cpp_train_tiny cpp_gpt_smoke cpp_dp cpp_ckpt cpp_compile_opts cpp_donation cpp_gather cpp_plugin_probe cpp_eager cpp_autograd cpp_jit cpp_module cpp_optim cpp_jit_train cpp_gpt_module cpp_oracle_ops cpp_oracle_grad cpp_oracle_layers cpp_robust cpp_equiv cpp_fd_grad
...
cpp_equiv: tests/cpp/test_equiv.cpp $(CPP_OBJ) $(CPP_HDRS) $(FWK_LIB)
	$(CXX) $(CXXFLAGS) -o $@ $< $(CPP_OBJ) -L./framework -ltpu_fw $(LDFLAGS)
cpp_robust: tests/cpp/test_robust.cpp $(CPP_OBJ) $(CPP_HDRS) $(FWK_LIB)
	$(CXX) $(CXXFLAGS) -o $@ $< $(CPP_OBJ) -L./framework -ltpu_fw $(LDFLAGS)
cpp_fd_grad: tests/cpp/test_fd_grad.cpp $(OP_TABLE_HDRS) $(CPP_OBJ) $(CPP_HDRS) $(FWK_LIB)
	$(CXX) $(CXXFLAGS) -o $@ $< $(CPP_OBJ) -L./framework -ltpu_fw $(LDFLAGS)
...
VERIFY_BINS = cpp_oracle_ops cpp_oracle_grad cpp_oracle_layers cpp_robust cpp_equiv cpp_fd_grad
verify: $(VERIFY_BINS)
	...
	@./cpp_robust
	@echo "── verification: eager↔jit equivalence ────────────────────────"
	@./cpp_equiv
	@echo "── verification: finite-difference gradient (oracle-free) ─────"
	@./cpp_fd_grad
