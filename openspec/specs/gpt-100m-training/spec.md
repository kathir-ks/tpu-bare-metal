...
Train a GPT-2-small-class (~124M param) model data-parallel across all 4 TPU v4
chips in the pure-C++ stack, consuming an offline-tokenized dataset with no
tokenizer in the runtime, with checkpoint round-trips and gradient accumulation
as needed.
