...
Provide a matched JAX baseline and a benchmark harness that measures and records
identical metrics for both the C++ and JAX stacks at a parity config, with
documented loss-curve agreement and repeatable results via a single make target
per stack.
